...
/// </summary>
public class HtmlGenerator : Notify
{
    ...
    public HtmlGenerator(string _title)
    {
        Title = _title; 
    }

    public HtmlGenerator(string _title,string _body)
    {
        Title = _title;
        Body = _body;
    }

    public HtmlGenerator(string _title,string _head,string _body)
    {
        Title = _title;
        Head = _head;
        Body = _body;
    ...
    public HtmlGenerator(string _title, string _head, string _body, string _script)
    {
        Title = _title;
        Head = _head;
        Body = _body;
